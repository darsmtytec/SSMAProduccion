...
elseif (file_exists('./tmhOAuth/tmhOAuth.php')) {
    require './tmhOAuth/tmhOAuth.php';
}
else {
    var_dump("tmhOAuth.php could not be found. have you tried installing with composer?");
    ...
    public function __construct($config = array())
    {
        ...
        $this->config = array_merge(
            array(
                ...
                'consumer_key' => '0O4NDYS28rd96Uh6uGENXvp5y',
                'consumer_secret' => '5Bv5v0TwNctAX1XFp6IgiCNQWPIcBbbw2XjByIHKwTaTBglrp8',
                'token' => '2756750930-6YPZhJNzv8ndgJHM6SFY2zFJluiZRqSJjf4PpLr',
                'secret' => 'P29vdR1GVdDroA0UY5BGYmVGEDumuqdzfEBFevHAIAFWy',
